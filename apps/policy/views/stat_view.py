...
class StatisticsAPIView(APIView):
    ...
    def get(self, request):
        ...
        all_expected_bank, all_current_bank = get_expected_bank_money(policies)
        start_expected_bank, start_current_bank = get_expected_bank_money(policies_last_start_of_month)
        thirty_expected_bank, thirty_current_bank = get_expected_bank_money(policies_last_30_days)
        seven_expected_bank, seven_current_bank = get_expected_bank_money(policies_last_7_days)
        one_expected_bank, one_current_bank = get_expected_bank_money(policies_today)


        # exptected money in the cash
        all_expected_cash, all_current_cash = get_expected_cash_money(policies)
        start_expected_cash, start_current_cash = get_expected_cash_money(policies_last_start_of_month)
        thirty_expected_cash, thirty_current_cash = get_expected_cash_money(policies_last_30_days)
        seven_expected_cash, seven_current_cash = get_expected_cash_money(policies_last_7_days)
        one_expected_cash, one_current_cash = get_expected_cash_money(policies_today)
        ...
        data = {
            "all":{
                ...
                "expected_money_bank": all_expected_bank,
                "current_money_bank": all_current_bank,
                "expected_money_cash": all_expected_cash,
                "current_money_cash": all_current_cash,
            },
            "start": {
                ...
                "expected_money_bank": start_expected_bank,
                "current_money_bank": start_current_bank,
                "expected_money_cash": start_expected_cash,
                "current_money_cash": start_current_cash,
            },
            "30": {
                ...
                "expected_money_bank": thirty_expected_bank,
                "current_money_bank": thirty_current_bank,
                "expected_money_cash": thirty_expected_cash,
                "current_money_cash": thirty_current_cash,
            },
            "7": {
                ...
                "expected_money_bank": seven_expected_bank,
                "current_money_bank": seven_current_bank,
                "expected_money_cash": seven_expected_cash,
                "current_money_cash": seven_current_cash,
            },
            "1": {
                ...
                "expected_money_bank": one_expected_bank,
                "current_money_bank": one_current_bank,
                "expected_money_cash": one_expected_cash,
                "current_money_cash": one_current_cash,
            },
        }
